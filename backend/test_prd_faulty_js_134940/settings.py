"""
Django settings for test_prd_faulty_js_134940 project.
...
ROOT_URLCONF = 'test_prd_faulty_js_134940.urls'
...
WSGI_APPLICATION = 'test_prd_faulty_js_134940.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_faulty_js_134940 API",
    "DESCRIPTION": "API documentation for test_prd_faulty_js_134940 App",
    "VERSION": "v1",
}
